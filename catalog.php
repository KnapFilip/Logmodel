...
<body>
    <div class="info">
        ...
        <div class="nav">
            <nav>
                <ul>
                    ...
                    <li class="active"><a href="catalog.php">Katalog</a></li>
        ...
        <h3>Zde si stačí vybrat druh dřeva</h3>

        <div class="products">
            <div class="bor">
                <h2><a href="html/wood/bor/bor.html">Borové</a></h2>
            </div>
            <div class="buk">
                <h2><a href="html/wood/buk/buk.html">Bukové</a></h2>
            </div>
            <div class="dub">
                <h2><a href="html/wood/dub/dub.html">Dubové</a></h2>
            </div>
            <div class="javor">
                <h2><a href="html/wood/javor/javor.html">Javorové</a></h2>
            </div>
            <div class="smrk">
                <h2><a href="html/wood/smrk/smrk.html">Smrkové</a></h2>
            </div>
            <div class="topol">
                <h2><a href="html/wood/topol/topol.html">Topolové</a></h2>
            </div>
        </div>
